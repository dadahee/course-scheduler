...
class Config:
    ...
    DEFAULT_SECTION_INDEX_FORMAT = '{section:02}'
    ...
    def __init__(self, config_path: str):
        ...
        self.include_course_name_header = self.get_config_value('include_course_name_header', True)
        ...
        self.lesson_index_format_str = self.get_nested_value('range_settings', 'lesson_index_format', self.DEFAULT_LESSON_INDEX_FORMAT)
        self.section_index_format_str = self.get_nested_value('range_settings', 'section_index_format', self.DEFAULT_SECTION_INDEX_FORMAT)
